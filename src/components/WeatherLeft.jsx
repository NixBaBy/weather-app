...
export const WeatherLeft = ({ selectedCity }) => {
  return (
    <div className="w-[414px] h-[832px] rounded-[48px] bg-[rgba(255, 255, 255, 0.75)] backdrop-blur-md relative z-10">
      ...
      <div className="mt-[-10px]">
        ...
        <Buttons />
        <div className="absolute right-[-40px] bottom-[-25px] -z-20">
